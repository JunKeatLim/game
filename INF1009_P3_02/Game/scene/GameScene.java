...
import INF1009_P3_02.Game.config.BackgroundChoice;
...
import INF1009_P3_02.Game.observer.AudioEventListener;
import INF1009_P3_02.Game.observer.LoggingEventListener;
import INF1009_P3_02.Game.observer.MovementEventListener;
...
public class GameScene extends Scene {
    ...
    public GameScene(SceneManager sceneManager, SettingsData settings, SimulationConfig config, GameEngineLogger logger) {
    ...
    public void show() {
        ...
        player = new Player(400, 300, 300, PLAYER_COLLISION_SIZE, PLAYER_DRAW_SIZE, WORLD_W, WORLD_H);
        player.loadTextures();
    ...
    public void update(float dt) {
        ...
        if (heartbeatTimer >= 10f) {
            heartbeatTimer = 0f;
            logger.info("Player pos: (" + (int)player.getX() + "," + (int)player.getY() + ") | Time: " + (int)timeLeft + "s | Score: " + score);
        }
