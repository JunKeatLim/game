...
public abstract class Trash extends Entity {
    ...
    private static final Map<TrashType, Texture> TEX = new EnumMap<>(TrashType.class);

    public Trash(float x, float y, float boundsW, float boundsH, float drawH, TrashType type) {
        super(x, y, 0);
